...
<input type="radio" name="gender" value="FEMALE">FEMALE<br/><br/>
			...
			<input name="address1" class="form-control" type="text" value="${customers.address1}" maxlength="25">
			 Address2:
			<input name="address2" class="form-control" type="text" value="${customers.address2}" maxlength="26" >
			 Zipcode:
			<input name="zipcode" class="form-control" type="text" value="${customers.zipcode }" maxlength="6" >
			 User Name:
			<input name="userName" class="form-control" type="text" value="${customers.userName}" maxlength="15" readonly="readonly">
			Password:
			<input name="passCode" class="form-control" type="password" pattern="/^[a-zA-Z0-9!@#\$%\^\&*_=+-]{8,12}$/g" value="${customers.passCode }" maxlength="15" readonly="readonly">
	...
	<c:if test="${param.customerName != null }">
		...
		<c:out value="${dao.updateCustomer(c)}"/>
