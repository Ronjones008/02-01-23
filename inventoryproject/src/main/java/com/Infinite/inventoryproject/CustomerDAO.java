...
public class CustomerDAO{
    ...
    public String addCustomer(Customer customer) throws IOException{
        ...
        cr.add(Restrictions.eq("customerPhoneNo",customer.getCustomerPhoneNo()));
        ...
        if (custList.size() > 0) {
            externalContext.redirect("AddCustomer.xhtml?exist=User Alredy Exists");
            return "check username or mobile number";}
...
//    public Customer SearchCustomerPhone(String customerPhoneNo ) {
//    	sessionFactory= SessionHelper.getConnection();
//    	Session session = sessionFactory.openSession();
//    	Criteria cr = session.createCriteria(Customer.class);
//    	cr.add(Restrictions.eq("customerPhoneNo", customerPhoneNo));
//    	List<Customer> customerList = cr.list();
//		return customerList.get(0);
//    	
//    	
